...
export default function Home() {
  ...
  return (
    <div className="space-y-12">
      {/* Hero section */}
      <section className="bg-blue-700 dark:bg-blue-800 text-white rounded-lg overflow-hidden">
        <div className="container mx-auto px-6 py-16 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <Link
              href="/productos"
              className="inline-flex items-center bg-white text-blue-700 dark:bg-gray-800 dark:text-white px-6 py-3 rounded-full font-semibold hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors"
            >
      ...
      <section className="bg-gray-100 dark:bg-gray-800 rounded-lg p-8 text-center">
        ...
        <Link
          ...
          className="inline-flex items-center bg-blue-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-blue-700 dark:hover:bg-blue-500 transition-colors"
        >
