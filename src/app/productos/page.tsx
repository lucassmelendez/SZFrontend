          ...
          <div className="w-full md:w-auto">
            <form onSubmit={handleSearchSubmit} className="relative">
              <input
                ...
                className="w-full md:w-64 pl-4 pr-10 py-2 rounded-full bg-white/20 border border-blue-300 backdrop-blur-sm text-white placeholder-blue-100 focus:outline-none focus:ring-2 focus:ring-white/50"
              />
              <button
                type="submit"
