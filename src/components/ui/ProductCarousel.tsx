  ...
  return (
    <div className="max-w-full mx-auto">
      ...
      <div className="relative">
        ...
        <button 
          onClick={prevSlide}
          className="absolute -left-0 sm:-left-8 top-1/2 -translate-y-1/2 z-10 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 p-2 sm:p-3 rounded-full shadow-md transition-colors"
          aria-label="Anterior"
        >
          <FaChevronLeft className="text-blue-600 dark:text-blue-400" />
        </button>
        
        <div className="relative overflow-hidden px-0 sm:px-8" ref={containerRef}>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-8 max-w-full mx-auto">
            {visibleProductos.map((producto) => (
              <div key={producto.id_producto} className="h-full transform scale-85 sm:scale-110 p-1 sm:p-2">
        ...
        <button 
          onClick={nextSlide}
          className="absolute -right-0 sm:-right-8 top-1/2 -translate-y-1/2 z-10 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 p-2 sm:p-3 rounded-full shadow-md transition-colors"
